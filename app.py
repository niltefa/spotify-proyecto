...
# ——— PRINT EN CONSOLA (opcional) ———
print("Últimas 50 canciones recuperadas:")
for t in items:
    print(f"{t['track']['name']} — {t['track']['artists'][0]['name']}")
...
# Filtrar solo pistas con ID (evita errores en podcasts, etc.)
